...
function InfoCard({img,title,text,color,isRight}) {
  return (
    ...
    <div className={`flex justify-center items-center flex-col w-[390px] min-w-[200px]
      ...
      <Image src={img}  width={'390px'} 
              className='border-2 xl:absolute rounded-t-3xl xl:rounded-full min-w-[200px]'/>
      <div className={`flex border-2 w-full h-auto max-h-[390px] ${color } rounded-b-3xl 
                       xl:h-full xl:rounded-3xl xl:items-center 
        ...
        <div className={`py-3 flex flex-col items-center pr-3 pl-3
          ...
          <p className='text-md py-2 font-[Raleway]'>
            {text}
          </p>
